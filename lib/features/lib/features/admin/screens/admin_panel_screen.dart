      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: const [
                Icon(Icons.security, color: AppColors.dangerRed, size: 30),
                SizedBox(width: 12),
                Expanded(
                  child: Text(
                    "Режим главного администратора активен.\nВам доступны все системные привилегии.",
                    style: TextStyle(color: AppColors.dangerRed, fontWeight: FontWeight.bold, fontSize: 13),
                  ),
                )
              ],
            ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: const [
                Text("• Сервер сквозного шифрования: ONLINE", style: TextStyle(color: AppColors.successGreen, fontSize: 13)),
                SizedBox(height: 4),
                Text("• WebSocket Gateway: v1.4 CONNECTED", style: TextStyle(color: AppColors.successGreen, fontSize: 13)),
                SizedBox(height: 4),
